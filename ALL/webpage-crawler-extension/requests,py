...
def main():
    df1 = pd.DataFrame(extractDigits(os.listdir('/home/student/TrackerSift/ASE-22/ALL/webpage-crawler-extension/server/output')), columns=['website'])
    tracking = 0
    functional = 0
    for j in df1.index:
        try:
